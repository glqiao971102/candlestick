...
import Chart1 from './1.9/1.9.csv'
import GameChart from './1.9/game1.9.csv'
    ...
    <>
      ...
      <div className="donut" style={{ padding: '0px 200px 0px 40px' }}>
        ...
        <Row style={{ marginTop: '20px', justifyContent: 'center', alignItems: 'center', textAlign: 'center' }}>
          ...
          <Col><Button disabled={counter != 0} size="lg" color='success' onClick={() => {
            ...
            // 
            // updateData()
          }}>Update</Button><Button size="lg" color='success' onClick={() => { updateData() }}>Update</Button>
          </Col>
        </Row>
